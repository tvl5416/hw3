...
The same size of the t values from different tests shows there's a real difference in quality between red and white 
wines. The direction of the difference flips in one test because of how we compared the wines. This tells that 
the way we set up our tests matters, but no matter how we do it, we see that red and white wines are different 
in quality.
